                    ...
                    @foreach($picReports as $picIndex => $picReport)
                        <tr>
                            ...
                            <td style="padding: 6px;">
                                <div class="{{ $picReport['status'] === 'KRITIS' ? 'text-danger' : ($picReport['status'] === 'SAFE' ? 'text-success' : '') }}" style="font-weight: bold;">
                                    {{ $picReport['status'] }}
                                </div>
                                ...
                                @if($picReport['status'] === 'KRITIS')
                                    ...
                                    @endphp
                                    <div class="meta-text" style="background-color: #fef2f2; color: #b91c1c; padding: 5px; border-left: 2px solid #ef4444; line-height: 1.4; margin-top: 5px;">
                                        <b>Temuan:</b><br>
                                        {{ $rincianRusak }}
                                    </div>
                                @elseif($picReport['status'] === 'SAFE')
                                    <div class="meta-text" style="color: #15803d; font-style: italic; margin-top: 4px;">
